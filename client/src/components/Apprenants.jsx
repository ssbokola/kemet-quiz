 ...
 * monte, l'effet ne rejoue pas, et le focus retombe sur <body>. Ici chaque vue
 * est un TYPE de composant distinct rendu à la même position — React démonte
 * l'ancienne, monte la nouvelle, l'effet de focus rejoue. Ne jamais fusionner
 * deux de ces vues dans un seul composant.
 *
 * Les officines vivaient ICI jusqu'à ce lot, sur exactement le même schéma que
 * les apprenants (liste, fiche, doublons). Ce chantier de réorganisation leur a
 * donné leur propre écran, à leur propre adresse (OfficinesEspace.jsx,
 * /formateur/officines) avec une disposition maître-détail : tout
 * l'aiguillage « officines » (liste, fiche, doublons, affectation en masse,
 * historique) a déménagé là-bas. Ne pas le reconstruire ici.
 */
